...
export const ComparisonSources = ({ sourceIds }: { sourceIds?: string[] }) => {
  ...
  return (
    <section className="mb-8 border-t border-noema-line pt-6" aria-labelledby="comparison-sources-heading">
      <h3 id="comparison-sources-heading" className="text-lg font-black">参照資料</h3>
